...
namespace SGA.Controllers
{
    ...
    public class ApplicationSQLController : Controller
    {
        private readonly IUnitOfWork _iuw;
        private readonly string LogDescription = "ApplicationSQL";
        public ApplicationSQLController(IUnitOfWork iuw)
        {
            _iuw = iuw;
        }
        ...
        public IActionResult Index(bool registroApagado)
        {
            try
            {
                ...
                var entityList = _iuw.ApplicationSQLRepository.GetList(null, x => x.Application, x => x.ApplicationType, x => x.DatabaseSGA);
        ...
        public IActionResult Create([Bind("Name,Description,ApplicationId,ApplicationTypeId,SQL,DatabaseSGAId,Enable")] ApplicationSQL entity)
        {
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    _iuw.ApplicationSQLRepository.Create(entity);
                    _iuw.Save();
        ...
        public IActionResult Edit(int? id)
        {
            try
            {
                ...
                var entity = _iuw.ApplicationSQLRepository.Get(x => x.Id == id, x => x.Application, x => x.ApplicationType, x => x.DatabaseSGA);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Edit(int id, [Bind("Id,Name,Description,ApplicationId,ApplicationTypeId,SQL,DatabaseSGAId,Enable")] ApplicationSQL entity)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    _iuw.ApplicationSQLRepository.Update(entity);
                    _iuw.Save();
        ...
        public IActionResult Delete(int? id)
        {
            try
            {
                ...
                var entity = _iuw.ApplicationSQLRepository.Get(x => x.Id == id);
                ...
                _iuw.ApplicationSQLRepository.Delete(entity);
                _iuw.Save();
        ...
        private ApplicationSQL SetUserDate(ApplicationSQL entity)
        {
        ...
        private void LoadFormFields(ApplicationSQL entity = null)
        {
            ...
            var applicationTypeList = _iuw.ApplicationTypeRepository.GetList(new List<Expression<Func<Models.ApplicationType, bool>>>() { x => x.Enable == EnumSGA.Status.Enabled, x => x.Id != (int)EnumSGA.ConnectionType.ConsultaCentroDeCustos }).OrderBy(x => x.Name);
            var databaseSGAList = _iuw.DatabaseSGARepository.GetList(new List<Expression<Func<Models.DatabaseSGA, bool>>>() { x => x.Enable == EnumSGA.Status.Enabled }).OrderBy(x => x.Name);
            ...
            if (entity == null)
            {
                ...
                ViewBag.DatabaseSGAId = new SelectList(databaseSGAList, "Id", "Name");
            ...
            else
            {
                ...
                ViewBag.DatabaseSGAId = new SelectList(databaseSGAList, "Id", "Name", entity.DatabaseSGAId);
