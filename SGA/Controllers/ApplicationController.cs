...
namespace SGA.Controllers
{
    ...
    public class ApplicationController : Controller
    {
        ...
        public ApplicationController(IUnitOfWork iuw)
        {
            _iuw = iuw;
        }
        ...
        public IActionResult Index(bool registroApagado)
        {
            try
            {
                var entityList = _iuw.ApplicationRepository.GetList(includeProperties: x => x.Environment);
        ...
        public IActionResult Create([Bind("Name,Description,EnvironmentId,Enable")] Application entity)
        {
            try
            {
                ...
                {
                    _iuw.ApplicationRepository.Create(entity);
                    _iuw.Save();
        ...
        public IActionResult Edit(int? id)
        {
            try
            {
                ...
                var entity = _iuw.ApplicationRepository.Get(x => x.Id == id, includeProperties: x => x.Environment);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Edit(int id, [Bind("Id,Name,Description,EnvironmentId,Enable")] Application entity)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    _iuw.ApplicationRepository.Update(entity);
                    _iuw.Save();
        ...
        public IActionResult Delete(int? id)
        {
            try
            {
                ...
                var entity = _iuw.ApplicationRepository.Get(x => x.Id == id);
                ...
                _iuw.ApplicationRepository.Delete(entity);
                _iuw.Save();
        ...
        [Authorize(Policy = "Administration")]
        private Application SetUserDate(Application entity) {
        ...
        private void LoadFormFields(Application entity = null)
        {
