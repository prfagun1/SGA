...
namespace SGA.Controllers
{
    ...
    public class ScheduleController : Controller
    {
        ...
        private readonly string LogDescription = "Schedule";
        public ScheduleController(IUnitOfWork iuw)
        {
            _iuw = iuw;
        }
        ...
        public IActionResult Index(bool registroApagado)
        {
            ...
            try
            {
                var entityList = _iuw.ScheduleRepository.GetList();
        ...
        public IActionResult Create([Bind("Name,Description,Time,Type,Enable")] Schedule entity)
        {
            try
            {
                ...
                {
                    _iuw.ScheduleRepository.Create(entity);
                    _iuw.Save();
        ...
        public IActionResult Edit(int? id)
        {
            try
            {
                ...
                var entity = _iuw.ScheduleRepository.Get(x => x.Id == id);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Edit(int id, [Bind("Id,Name,Description,Time,Type,Enable")] Schedule entity)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    _iuw.ScheduleRepository.Update(entity);
                    _iuw.Save();
        ...
        public IActionResult Delete(int? id)
        {
            try
            {
                ...
                _iuw.ScheduleRepository.Delete(entity);
                _iuw.Save();
        ...
        private Schedule SetUserDate(Schedule entity)
        {
        ...
        private void LoadFormFields(Schedule entity = null)
        {
            if (entity == null)
            {
                ViewBag.EnableSelect = Lib.ControllersHelper.GetSelectList(EnumSGA.Status.Enabled);
                ViewBag.TypeSelect = Lib.ControllersHelper.GetSelectList(EnumSGA.ScheduleType.ImportUsersAndGrups);
            }
            else
            {
                ViewBag.EnableSelect = Lib.ControllersHelper.GetSelectList(entity.Enable);
                ViewBag.TypeSelect = Lib.ControllersHelper.GetSelectList(entity.Type);
            }
        }
