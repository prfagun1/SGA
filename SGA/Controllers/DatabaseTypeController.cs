...
namespace SGA.Controllers
{
    ...
    public class DatabaseTypeController : Controller
    {
        ...
        private readonly string LogDescription = "DatabaseType";
        public DatabaseTypeController(IUnitOfWork iuw)
        {
            _iuw = iuw;
        }
        ...
        public IActionResult Index(bool registroApagado)
        {
            ...
            try
            {
                var entityList = _iuw.DatabaseTypeRepository.GetList();
        ...
        public IActionResult Create([Bind("Name,Description,Enable")] DatabaseType entity)
        {
            try
            {
                ...
                {
                    _iuw.DatabaseTypeRepository.Create(entity);
                    _iuw.Save();
        ...
        public IActionResult Edit(int? id)
        {
            try
            {
                ...
                var entity = _iuw.DatabaseTypeRepository.Get(x => x.Id == id);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Edit(int id, [Bind("Id,Name,Description,Enable")] DatabaseType entity)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    _iuw.DatabaseTypeRepository.Update(entity);
                    _iuw.Save();
        ...
        public IActionResult Delete(int? id)
        {
            try
            {
                ...
                _iuw.DatabaseTypeRepository.Delete(entity);
                _iuw.Save();
        ...
        private DatabaseType SetUserDate(DatabaseType entity)
        {
        ...
        private void LoadFormFields(DatabaseType entity = null)
        {
